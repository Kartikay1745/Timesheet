...
//     // Check for valid users and ALWAYS include username property
//     let userInfo = null;
//     if (user.toLowerCase() === "jane.smith") {
//       userInfo = { 
//         id: "jane", 
//         name: "Jane Smith", 
//         role: "viewer", 
...
//       showToast("Welcome! Logging you in...", "success");
//     } else {
//       // Any other username gets admin access
//       userInfo = { 
//         id: user.toLowerCase().replace(/[^a-zA-Z0-9]/g, ''), // Clean ID from username
//         name: user.split('.').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' '), // Format name
//         role: "admin", 
...
//         // Navigate to dashboard for both roles - MainTable will handle the role-based UI
//         setTimeout(() => {
//           navigate("/dashboard");
//         }, 1000);
